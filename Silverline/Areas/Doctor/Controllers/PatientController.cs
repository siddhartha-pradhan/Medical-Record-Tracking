...
public class PatientController : Controller
{
    ...
    public async Task<IActionResult> Add(AddPatientViewModel patient, IFormFile image)
    {
        ...
        var result = await _userManager.CreateAsync(user, "Silverline@123");
        ...
        if (result.Succeeded)
        {
            ...
            await _emailSender.SendEmailAsync(patient.EmailAddress, "Email Confirmation",
                $"Dear {user.FullName},<br><br>You have been registered to our system as a patient. <br>You can log in to the system through the following credentials of your email address and password as <b>\"Silverline@123\"</b>.<br><br>Regards,<br>Silverline Hospital");
