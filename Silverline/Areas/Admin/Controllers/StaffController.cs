		...
		if (result.Succeeded)
		{
			...
			switch (role)
			{
				case "Doctor":
					...
					$"Dear {userModel.Name}, <br><br>Your request has been accepted and you have been registered to our system as a doctor. <br>Please use your registered email and password as <b>\"Silverline@123\"</b> as the login credential for the system.<br>Regards,<br>Silverline Hospital");
				...
				case "LabTechnician":
					...
					await _emailSender.SendEmailAsync(userModel.Email, "Successful Registration",
					$"Dear {userModel.Name}, <br><br>Your request has been accepted and you have been registered to our system as a lab technician. <br>Please use your registered email and password as <b>\"Silverline@123\"</b> as the login credential for the system.<br>Regards,<br>Silverline Hospital");
				...
				case "Pharmacist":
					...
					await _emailSender.SendEmailAsync(userModel.Email, "Successful Registration",
					$"Dear {userModel.Name}, <br><br>Your request has been accepted and you have been registered to our system as a pharmacist. <br>Please use your registered email and password as <b>\"Silverline@123\"</b> as the login credential for the system.<br>Regards,<br>Silverline Hospital");
