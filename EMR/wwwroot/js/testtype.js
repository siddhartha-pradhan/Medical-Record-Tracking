...
function loadDatasTable() {
    dataTable = $('#tableDatas').DataTable({
        "ajax": {
            "url": "/LabTechnician/TestType/GetAll"
        },
        "columns": [
            { "data": "name", "width": "40%" },
            {
                ...
                "render": function (data) {
                    return `
                        <div class="text-center">
                            <a href="/LabTechnician/TestType/Upsert/${data}" class="btn btn-info text-white" style="cursor: pointer">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            <a href="/LabTechnician/TestType/Delete/${data}" class="btn btn-danger text-white" style="cursor: pointer">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                        </div>
                    `;
